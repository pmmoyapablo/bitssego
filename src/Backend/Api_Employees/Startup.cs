      ...
      services.AddAuthorization(auth =>
      {
          ...
          services.AddSwaggerGen(config =>
            {
              ...
              {
                Title = "Api de Info de Empleados SGO",
                Version = "v1",
                Contact = new OpenApiContact() { Name = "Pablo Moya", Email = "pmoya@thefactoryhka.com" },
                Description = "Representa la informacion de los Epleados The Factory HKA en SGO"
              }
              );
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(config =>
              config.SwaggerEndpoint("/swagger/v1/swagger.json", "Api Empleados SGO")
            );
          }
    }
}
