    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddSwaggerGen(config =>
           {
             ...
             {
               Title = "Api de Operaciones SGO",
               Version = "v1",
               Contact = new OpenApiContact() { Name = "Pablo Moya", Email = "pmoya@thefactoryhka.com" },
               Description = "Representa todos las Operaciones con Productos de Clientes de SGO Venezuela"
             });
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(config =>
              {
                config.SwaggerEndpoint("/swagger/v1/swagger.json", "API de Operaciones SGO VE");
              //  config.RoutePrefix = "ApiOperations/swagger";
              }
            );
         }
    }
